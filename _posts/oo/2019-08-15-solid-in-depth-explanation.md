...
接口隔离原则对我们的行为做了约束，不应该是我们自身为了图一时的方便，塞给用户一些他不需要的东西，而应该是用户要什么，我们就给他什么。
...
依赖倒置原则揭露了一个工作中非常重要协作准则：部门之间通过约定好的协议来合作，而不关心对方内部由谁做协议所规定的事项。
...
## SRP：各司其职，工作效率会大大提升
单一职责原则告诉我们一个重要的处世态度 -- *勿贪多，贪多你将可能迷失自我。*
...
分离关注点是提高效率的一个很好的途径，如果你同时需要兼顾多项不太相关的工作，你的注意力经常在不同的上下文切换，会降低工作效率，企业为你付出的成本就会增加，更糟糕的是可能会出现一些意外的灾难。
...
我在*敏捷工程实践训练营* 中经常会告诉学员："了解了SOLID设计原则的原理之后，你要做的是忘掉他们，然后拾起两把接地气的武器来写代码 -- `TDD` && `简单设计`。"

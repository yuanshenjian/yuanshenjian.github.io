...
>
> 袁Sir从一开始图一时的方便，塞给顾客他本不需要的东西，经过思考后，从顾客需求出发，只提供顾客想要的东西。*投其所好* 是他创业悟出的第一个处世之道
...
里氏替换原则则重申了一句古言：*有其父，必有其子*。同样，*有其师，必有其徒*。
...
>
>此时袁Sir终于才体会到当老板的一丁点美好了，下班了，合上电脑前他敲下了一句话：*部门之间得通过约定好的协议来合作，而不用关心对方内部由谁做协议所规定的事项*。

袁Sir的做法体现了依赖倒置原则精髓，他本来认识的是一个个提供某项服务并且具体执行的人，为了解放自，他只用认识一个提供服务的接口人，而由谁去做具体的事情他再也不用关心。
...
>
>袁Sir睡觉前，打开电脑备忘录写下：*分离关注点（专注）是做好一件事的有效途径，如果同时需要兼顾多项不太相关的工作，注意力就必须在不同的上下文切换，会大大降低工作效率，更糟糕的是可能会出现一些意外的灾难*。敲完后欣慰睡去。
...
开闭原则诠释着一个互联网产品用户体验的真谛：*把用户当"傻瓜"，知道的越少，用起来越简单，用户就越舒服。*

...
做了这么多年的面向对象编程还是写出违背SOLID原则的代码，一看都懂、一做就被怼，不敏感不够，如何是好？
...
最后，我想跟技术人员共享一个词汇 -- 用户视角：

***我们学到了的很多技巧（设计原则、设计模式、重构手法等），如果忘记初衷，失去目标，代码写得再炫酷、再健壮，也很难体现出应有的价值。本着从业务需求为出发点，以用户视角看问题，致力编写出 简洁可用 的代码即可。***

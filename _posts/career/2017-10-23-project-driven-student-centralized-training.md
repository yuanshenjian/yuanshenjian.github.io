...
brief: "因为一次非偶然的机会，我作为Coach对项目即将接纳的5个应届生（后称做小伙伴）进行封闭式脱产培训。此次培训是由ThoughtWorks北京Office和思沃学院联手推出的Local项目人才培养计划中的一个环节，也是小伙伴们上项目之前的最后一站。
<br/><br/>
经过三周左右的高强度培训，小伙伴们陆续融入项目中接受考验。而作为Coach，我想通过本文分享一些有关培训的经验和心得。
<br/><br/>
受思沃学院*以学习者为中心的教学* 启发，我给此次培训起名为 *以学习者为中心的项目驱动培训*，一来突显培训的极强目标性 -- *更好更快地上项目实战*，二来诠释以项目为驱动的培训是一种有效、快速的能力培养方式。
"
---
...
## 项目驱动
作为Coach对项目即将接纳的5个应届生（后称做小伙伴）进行"封闭式"脱产培训。此次培训是由ThoughtWorks北京Office和思沃学院联手推出的Local项目人才培养计划中的一个环节。经过三周左右的高强度培训，小伙伴们陆续融入项目中接受考验。而作为Coach，我想通过本文分享一些有关培训的经验和心得。
...
## 培训体系
不同于象牙中的以老师为中心填鸭式教学，*以学习者为中心* 的培训主要围绕学生来开展。然而，初出象牙塔的新人可能仍然保留了较为强烈的`学生-老师`的象牙塔意识。在培训开始阶段Coach需要识别出他们的 *`意识形态`*，并帮助其调整。

整个培训贯穿一个宗旨 -- 新人通过培训后能够*更快*、*更好* 地为项目做贡献。在大目标的指引下，配合一系列合理且可以落地的验收标准，*`以可验收的目标为导向`*。

ThoughtWorks特有的敏捷文化告诉我，在培训过程中坚持持续 *`反馈优化`*，并将 *`敏捷实践渗透`* 到培训中，通过 *`激励式教学`*，同时要求Coach提前识别出潜在的风险，做好 *`风险把控`* 工作。必要的时候尝试引入 *`惩罚机制`*。最后，经常被忽视的*`健身运动`*则有助于我们保持持久的学习和工作热情。

*以学习者为中心的项目驱动培训* 的培训体系将涉及九大方面：
...
意识形态，某种意义上又回到了认知的问题。我在 [改善程序员生活质量的 3+10 习惯]({{'/10-habbits-improve-developers-life/'}}) 中提到 *认知是一切的基础*。对于刚从象牙塔中走出来的小伙伴们，他们对学习上的认知会直接影响培训中的学习方式和学习效率。

##### 削弱象牙塔意识
基于之前当Buddy的经验，我发现一些刚步入职场的新人思维中依然充斥着较强的象牙塔意识。典型的表现是 *张口闭口：老师，我遇到问题了，怎么办？*。他们在遇到问题后的第一时间想到的是跟老师要答案，而不是自己先冷静下来去跟问题对话。作为Coach，如果每次遇到这样的求助之后都无条件的给与帮助，只会助长其这种意识。在觉察到这种现象的时候，可以采取以下措施：
...
##### 建立Owner意识
左边做减法，右边做加法。责任意识的建立对他们来说也很重要，比如可以给`Retro`、`Code Review`、`Standup`指定Owner。他们一旦作为Owner，往往不只是自己深刻掌握了这些敏捷实践，还能够成为Driver。

Owner意识的提高会驱使他们不断地自我学习，突破自己，从而挑战更多的职责，在团队内建立更广的影响力，有利于团队协作。

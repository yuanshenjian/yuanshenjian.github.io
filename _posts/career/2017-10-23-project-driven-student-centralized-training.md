...
## 项目驱动
因为项目上的一次非偶然的机会，我作为Coach对项目即将接纳的5个应届生（后称做小伙伴）进行"封闭式"脱产培训。此次培训是由ThoughtWorks北京Office和思沃学院联手推出的Local项目人才培养计划中的一个环节，也是小伙伴们上项目之前的最后一站。
...
## 培训体系
不同于象牙中的以老师为中心填鸭式教学，*以学习者为中心* 的培训，强调地是围绕学生来开展。然而，刚从象牙塔走出来的小伙伴们的意识会不会仍然处在`学生-老师`的象牙塔模式？所以，在培训开始阶段Coach的一个重要的工作就是识别并调整他们的 *`意识形态`*。

整个培训贯穿一个宗旨 -- 小伙伴们通过培训后能够*更快*、*更好* 地为项目贡献*更大* 力量。大目标明确后，我们另外需要要制定一系列合理且可以落地的验收标准，做到*`以可验收的目标为导向`*。

项目驱动决定了培训技能都源自于项目，所以Coach需要梳理出项目的 *`技能体系`*，进行有效的可视化，并按照重要程度和依赖关系植入到培训计划中。

迈出了第一步，ThoughtWorks的敏捷文化告诉我们，在培训过程中要坚持做到持续 *`反馈优化`*，将我们的 *`敏捷实践渗透`* 到过程中，并在过程中实施 *`激励式教学`*，同时要求Coach提前识别出潜在的风险，做好 *`风险把控`* 工作。必要的时候尝试引入 *`惩罚机制`*。最后，经常被忽视的*`健身运动`*则有助于我们保持持久的学习和工作热情。

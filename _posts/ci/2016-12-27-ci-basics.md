...
![Alt text]({{ site.url }}{{ site.images }}{{ '/dojo/ci/ci-flow.png' }})
...
![Alt text]({{ site.url }}{{ site.images }}{{ '/dojo/ci/one-more.png' }})
...
![Alt text]({{ site.url }}{{ site.images }}{{ '/dojo/ci/jenkins-verify.png' }})
...
![Alt text]({{ site.url }}{{ site.images }}{{ '/dojo/ci/jenkins-dashboard.png' }})

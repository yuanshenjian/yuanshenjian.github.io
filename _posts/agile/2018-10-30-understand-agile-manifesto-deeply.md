...
我认为敏捷更像一种文化价值的认同，相比于形式，更重要的是团队对敏捷价值观的理解和认同，以及指导他们做出日常行为的潜意识中是否具备`尊重`、`勇气`、`开放`、`承诺`、`专注`这些特征。一个敏捷的团队中，每个成员都应该拥有持续改进的心态，他们会不断学习理解敏捷宣言的内涵，会不断提升自己的专业技能，并能够结合团队实际情况采取因地制宜的敏捷实践

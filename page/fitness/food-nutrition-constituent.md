...
![]({{ site.url }}{{ site.img_path }}{{ '/fitness/food/main-food.jpg' }})
...
| 鸡胸肉 | 白肉，富含蛋白质，脂肪含量少，适合增肌或减脂 | 100 | 101.0/423.19 | 2.5 | 19.4 | 1.5 |
...
![]({{ site.url }}{{ site.img_path }}{{ '/fitness/food/protein.jpg' }})

*饮食推荐*

```
1. 每天摄入蛋黄不超过2个。
2. 乳清蛋白粉在锻炼后30分钟补充或作为加餐食用。
```
...
![]({{ site.url }}{{ site.img_path }}{{ '/fitness/food/vegetables.jpg' }})
...
| 圣女果 | 茄类水果，含糖低，含有一定的胡萝卜素和钾，可适量食用 | 100 | 22.0/92.18 | 5.8 | 1.0 | 0.2 |

![]({{ site.url }}{{ site.img_path }}{{ '/fitness/food/fruit.jpg' }})
...
![]({{ site.url }}{{ site.img_path }}{{ '/fitness/food/nut.jpg' }})
